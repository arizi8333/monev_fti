                            ...
                            @foreach($data1 as $d)
                                @if($d->status == 2)
                                    @if($d->timeline_perkuliahan == 1)
                                        <button class="btn btn-sm btn-info" id="berkas" data-id="{{$d->id}}"><i class="fa fa-file"></i> Kelengkapan Dokumen Perkuliahan</button>
                                    @elseif($d->timeline_perkuliahan == 2)
                                        <button class="btn btn-sm btn-info" id="uts" data-id="{{$d->id}}"><i class="fa fa-file"></i> Soal Ujian Tengah Semester</button>
                                    @elseif($d->timeline_perkuliahan == 3)
                                        <button class="btn btn-sm btn-info" id="uas" data-id="{{$d->id}}"><i class="fa fa-file"></i> Soal Ujian Akhir Semester</button>
                                    @endif
                                @endif
                            @endforeach

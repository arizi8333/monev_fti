            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group" id="div_nama">
                        {{Form::label('text', 'Fakultas :', ['class' => 'awesome'])}}
                        {{Form::text('fakultas','',['class' => 'form-control', 'id' => 'fakultas', 'placeholder' => 'fakultas ...'])}}
                    </div>

                            ...
                            @forelse($data as $d)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a style="text-decoration:none" href="{{url('/jurusan/monitoring/detail')}}/{{$d->id}}" data-id="{{$d->id}}" data-id1="{{$d->timeline_perkuliahan}}" id="detail" title="Detail"><i class="fa fa-ellipsis-h"></i></a>
                                    </td>
                                </tr>
                            @empty

                ...
                <div class="card-header py-3">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            <a href="#" id="add1" data-id="{{$data->id}}" class="btn btn-danger btn-sm">
                            ...
                            ?>
                                @forelse($berkas as $b)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a style="text-decoration:none" href="#" data-id="{{$b->id_kategori_berkas}}" data-nama="{{$b->nama_berkas}}" data-id1="{{$b->id_kelas_perkuliahan}}" id="add" class="text-secondary" title="Detail"><i class="fa fa-ellipsis-h"></i></a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr class="text-center">
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="id_kelas_perkuliahan" id="id_kelas_perkuliahan" value="">
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="id_hasil_verifikator" id="id_hasil_verifikator" value="">
                    
                    @foreach($kategori as $k)

                    <div class="form-group" id="div_nama">
                        {{Form::label('text', 'Kategori Penilaian :', ['class' => 'awesome'])}}
                        <input type="text" name="kategori_penilaian[]" id="kategori_penilaian" value="{{$k->kelengkapan_dokumen}}" class="form-control" readonly>
                        <input type="hidden" name="id_jenis_penilaian[]" id="id_jenis_penilaian" value="{{$k->id}}">
                    </div>
